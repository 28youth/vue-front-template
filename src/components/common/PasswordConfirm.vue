<template>
  <div class="c-password-confirm" @touchmove.prevent>
    ...
    <Transition name="toast">
      <div v-if="visible" class="m-pop-box" @click="cancel" />
    </Transition>
        ...
        <main>
          <form onsubmit="return false">
            <label class="input-wrap">
              <input ref="content" v-model="password" type="password" minlength="6" maxlength="16" />
            </label>
            <button :disabled="disabled" type="submit" @click="submit">
              {{ $t('confirm') }}
            </button>
          </form>
