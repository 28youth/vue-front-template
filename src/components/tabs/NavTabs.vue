<template>
  <div :id="id">
    <VTabs v-if="navs.length > 0" :class="{ fixed }" :value="curTab" @change="handleTabChange">
      <VTab v-for="({ path, title }, index) in navs" :key="index" :title="title" :value="path" />
    </VTabs>
...
<style src="./tabs.less" lang="less"></style>
